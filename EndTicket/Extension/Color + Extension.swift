...
extension Color{
    static let gray10 = Color(#colorLiteral(red: 0.9803921569, green: 0.9803921569, blue: 0.9803921569, alpha: 1))
    ...
    static let gray400 = Color(#colorLiteral(red: 0.6, green: 0.6, blue: 0.6, alpha: 1))
    ...
    static let mainColor = Color(#colorLiteral(red: 0.0431372549, green: 0.6470588235, blue: 0.9254901961, alpha: 1))
    ...
    //MARK: - 캐릭터 관련
    static let kia = Color(hex: "#E7988C")
    static let cheese = Color(hex: "#F1CE74")
    static let vega = Color(hex: "#98C4EA")
